...
public class NewEventValidatorTimeNow {
    ...
    void shouldCheckThatFromIsNull() {
        NewEventDto input = NewEventDto.builder().itemName("przykad")
                ...
                .build();
        List<String> result = NewEventDtoValidatorTimeNow.validate(input, new TimeNowStub());
    ...
    void shouldCheckNewEventNull() {
        List<String> result = NewEventDtoValidatorTimeNow.validate(null, new TimeNowStub());
